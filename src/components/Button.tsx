...
export function Button({
  ...
  return (
    ...
    ${
      (color === 'red' &&
        'border border-transparent bg-red-500 text-gray-200 transition-colors duration-500 hover:bg-red-600 disabled:bg-transparent disabled:text-red-500') ||
      (color === 'green' &&
        'border border-transparent bg-green-500 text-gray-200 transition-colors duration-500 hover:bg-green-600 disabled:bg-transparent disabled:text-green-500') ||
      (color === 'yellow' &&
        'border border-transparent bg-yellow-500 text-gray-200 transition-colors duration-500 hover:bg-yellow-600 disabled:bg-transparent disabled:text-yellow-500') ||
      (color === 'default' &&
